...
if __name__ == '__main__':
    ...
    try:
        #ssd = get_VGG16_SSD_300(image_size=(300,300,3), num_classes=21)
        ssd = get_mobilenet_SSD(image_size=(300,300,3), num_classes=21)
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (_, imgs, gt_confs, gt_locs) in enumerate(batch_generator):
            ...
            print('batch number =', i+1, 'of', args.num_batches)
